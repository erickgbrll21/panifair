...
export const EDICAO_2026_STATS = [
  { value: 22500, suffix: "+", label: "Visitantes qualificados" },
  { value: 410, suffix: "+", label: "Expositores nacionais e internacionais" },
...
export const EDICAO_2026_TIMELINE = [
  ...
  {
    day: "Dia 3 · 21 ago",
    theme: "Negócios e parcerias",
    items: ["Reuniões corporativas", "Showroom ao vivo", "Rodada internacional"],
  },
  {
    day: "Dia 4 · 22 ago",
    theme: "Encerramento",
    items: ["Últimas oportunidades comerciais", "Premiação de expositores", "Anúncio PANIFAIR 2027"],
  },
] as const;
