...
export const PANIFAIR_EMAIL = "comercial@panifair.com";
export const PANIFAIR_INSTAGRAM_HANDLE = "@panifair";
export const PANIFAIR_INSTAGRAM_URL = "https://www.instagram.com/panifair/";
