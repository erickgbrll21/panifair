...
export function HeroIntro() {
  return (
    <section
      id="idealizador"
      className="section-warm section-hero-intro relative scroll-mt-24 overflow-hidden pb-[var(--section-spacing-y)] pt-0"
    >
      <SectionSideDecor />
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-32 top-1/2 h-[520px] w-[520px] rounded-full bg-[rgba(176,132,80,0.1)] blur-[100px]"
      />
      ...
      <div className="container-panifair relative z-10">
        ...
        <Reveal delay={0.1}>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[#7a5532] md:text-xl">
        ...
        <div className="mt-10 flex items-center gap-4 md:mt-12 md:gap-6">
          ...
          <span className="section-eyebrow shrink-0 text-[11px] font-bold uppercase tracking-[0.3em]">
            Quem idealiza
          </span>
