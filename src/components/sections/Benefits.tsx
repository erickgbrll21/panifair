      ...
      <div className="container-panifair grid gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:col-span-7">
          {BENEFITS.map((benefit, i) => (
            <Reveal key={benefit.title} delay={0.05 + i * 0.05} className="h-full">
              <article className="glass-card group relative flex h-full flex-col rounded-2xl p-6 transition-colors duration-300 hover:border-[#a67c52]">
                <span
                  aria-hidden
